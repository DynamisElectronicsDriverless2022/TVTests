...
typedef struct {
  dsp_simulink_MovingAverage_l obj;    /* '<S283>/Moving Average' */
  dsp_simulink_MovingAverage obj_o;    /* '<S171>/Moving Average' */
  zGeneral_Params General_Params;      /* '<S3>/Data Store_General_Params' */
  real_T CFunction[26];                /* '<S152>/C Function' */
  real_T Probe[2];                     /* '<S287>/Probe' */
  real_T Probe_g[2];                   /* '<S296>/Probe' */
  real_T CFunction_d[4];               /* '<S246>/C Function' */
  real_T CFunction_f[4];               /* '<S247>/C Function' */
  ...
  real_T Integrator_DSTATE_a[4];       /* '<S292>/Integrator' */
  real_T UnitDelay1_DSTATE[4];         /* '<S11>/Unit Delay1' */
  real_T Integrator_DSTATE_e[4];       /* '<S301>/Integrator' */
  real_T UnitDelay2_DSTATE[4];         /* '<S11>/Unit Delay2' */
  real_T DiscreteFIRFilter_states[4];  /* '<S156>/Discrete FIR Filter' */
  real_T UnitDelay_DSTATE_f[4];        /* '<S17>/Unit Delay' */
  real_T Integrator_DSTATE_k[4];       /* '<S119>/Integrator' */
  real_T UnitDelay_DSTATE_b[4];        /* '<S23>/Unit Delay' */
  real_T UnitDelay_DSTATE_j[4];        /* '<S1>/Unit Delay' */
  real_T Memory_PreviousInput[4];      /* '<S139>/Memory' */
  real_T yaw_rate_desired_LUT;         /* '<S140>/Merge_LUT_results' */
  real_T yaw_rate_desired_LUT_h;       /* '<S140>/Merge_LUT_results1' */
  real_T Integrator_DSTATE_b;          /* '<S208>/Integrator' */
  real_T Filter_DSTATE;                /* '<S203>/Filter' */
  real_T tr;                           /* '<S236>/Distribution complete' */
  real_T Rw;                           /* '<S236>/Distribution complete' */
  int32_T DiscreteFIRFilter_circBuf;   /* '<S156>/Discrete FIR Filter' */
  int8_T Integrator_PrevResetState;    /* '<S62>/Integrator' */
  int8_T Integrator_PrevResetState_i;  /* '<S292>/Integrator' */
  int8_T Integrator_PrevResetState_c;  /* '<S301>/Integrator' */
  int8_T Integrator_PrevResetState_n;  /* '<S208>/Integrator' */
  int8_T Filter_PrevResetState;        /* '<S203>/Filter' */
  int8_T Integrator_PrevResetState_ig; /* '<S119>/Integrator' */
  uint8_T Integrator_IC_LOADING;       /* '<S292>/Integrator' */
  uint8_T Integrator_IC_LOADING_m;     /* '<S301>/Integrator' */
  uint8_T is_active_c21_TVModel;       /* '<S283>/T_Req_Chart' */
  uint8_T is_c21_TVModel;              /* '<S283>/T_Req_Chart' */
  ...
  uint8_T is_TS_ON_l;                  /* '<S17>/Activation logic' */
  uint8_T is_FL_g;                     /* '<S17>/Activation logic' */
  uint8_T is_FR_i;                     /* '<S17>/Activation logic' */
  uint8_T is_RL_g;                     /* '<S17>/Activation logic' */
  uint8_T is_RR_p;                     /* '<S17>/Activation logic' */
  boolean_T Memory_PreviousInput_k;    /* '<S253>/Memory' */
  boolean_T Memory_PreviousInput_kk;   /* '<S254>/Memory' */
  boolean_T Memory_PreviousInput_b;    /* '<S255>/Memory' */
  boolean_T Memory_PreviousInput_a;    /* '<S256>/Memory' */
  boolean_T Memory_PreviousInput_n;    /* '<S228>/Memory' */
  boolean_T IC_FirstOutputTime;        /* '<S232>/IC' */
  boolean_T IC1_FirstOutputTime;       /* '<S233>/IC1' */
...
typedef struct {
   ...
   * Referenced by:
   *   '<S158>/Constant1'
   *   '<S243>/2-D Lookup Table'
   *   '<S271>/2-D Lookup Table'
   */
  real_T pooled5[4000];
   ...
   * Referenced by:
   *   '<S284>/2-D Lookup Table'
   *   '<S293>/2-D Lookup Table'
   ...
   * Referenced by:
   *   '<S281>/Max_Torque_Overload_Inverter_LUT'
   *   '<S281>/Max_Torque_Overload_Motor_LUT'
   *   '<S281>/Max_Torque_Temperature_External_LUT'
   *   '<S281>/Max_Torque_Temperature_IGBT_LUT'
   *   '<S281>/Max_Torque_Temperature_Internal_LUT'
   *   '<S282>/Display Overload Inverter LUT'
   *   '<S282>/Display Overload Motor LUT'
   *   '<S282>/Temperature External LUT'
   *   '<S282>/Temperature IGBT LUT'
   *   '<S282>/Temperature Internal LUT'
   */
  real_T pooled47[3];
   ...
   * Referenced by: '<S251>/2-D Lookup Table1'
   */
 ...
 * Block '<S147>/Sum of Elements' : Unused code path elimination
 * Block '<S244>/NOT' : Unused code path elimination
 ...
 * Block '<S236>/Signal Conversion' : Eliminate redundant signal conversion block
 * Block '<S140>/Cast To Double' : Eliminate redundant data type conversion
 * Block '<S140>/Cast To Double1' : Eliminate redundant data type conversion
 * Block '<S140>/Cast To Double2' : Eliminate redundant data type conversion
 * Block '<S140>/Cast To Double3' : Eliminate redundant data type conversion
 * Block '<S140>/Cast To Double4' : Eliminate redundant data type conversion
 * Block '<S140>/Cast To Double5' : Eliminate redundant data type conversion
 * Block '<S140>/Cast To Double6' : Eliminate redundant data type conversion
 * Block '<S140>/Cast To Double7' : Eliminate redundant data type conversion
 * Block '<S281>/Cast_0' : Eliminate redundant data type conversion
 * Block '<S281>/Cast_1' : Eliminate redundant data type conversion
 * Block '<S281>/Cast_2' : Eliminate redundant data type conversion
 * Block '<S281>/Cast_3' : Eliminate redundant data type conversion
 * Block '<S281>/Cast_4' : Eliminate redundant data type conversion
 * Block '<S292>/Saturation' : Eliminated Saturate block
 * Block '<S285>/K' : Eliminated nontunable gain of 1
 * Block '<S282>/Cast_0' : Eliminate redundant data type conversion
 * Block '<S282>/Cast_1' : Eliminate redundant data type conversion
 * Block '<S282>/Cast_2' : Eliminate redundant data type conversion
 * Block '<S282>/Cast_3' : Eliminate redundant data type conversion
 * Block '<S282>/Cast_4' : Eliminate redundant data type conversion
 * Block '<S301>/Saturation' : Eliminated Saturate block
 * Block '<S294>/K' : Eliminated nontunable gain of 1
 */
 ...
 * '<S228>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/Mz Generation/Steer Activation/S-R Flip-Flop'
 * '<S229>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/Polytopic Constraints/Driver Inputs'
 * '<S230>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/Polytopic Constraints/Driver g'
 * '<S231>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/Polytopic Constraints/MATLAB Function3'
 * '<S232>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/Polytopic Constraints/Power Limits Negative'
 * '<S233>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/Polytopic Constraints/Power Limits Positive'
 * '<S234>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/Polytopic Constraints/Subsystem'
 * '<S235>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/Polytopic Constraints/Subsystem1'
 * '<S236>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/Polytopic Constraints/Subsystem2'
 * '<S237>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/Polytopic Constraints/Driver Inputs/Accelerator Mapping '
 * '<S238>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/Polytopic Constraints/Driver Inputs/Saturation Dynamic'
 * '<S239>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/Polytopic Constraints/Driver g/Coasting'
 * '<S240>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/Polytopic Constraints/Subsystem2/Distribution complete'
 * '<S241>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/Polytropic Matrix/Efficiency limit'
 * '<S242>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/Polytropic Matrix/MATLAB Function'
 * '<S243>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/Polytropic Matrix/Efficiency limit/Power to engines'
 * '<S244>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/States Constraints/Anti reverse wheelspin'
 * '<S245>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/States Constraints/Brake & ESP'
 * '<S246>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/States Constraints/Bus lbx'
 * '<S247>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/States Constraints/Bus ubx'
 * '<S248>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/States Constraints/Cross Check'
 * '<S249>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/States Constraints/Low YRD'
 * '<S250>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/States Constraints/Tire Bound Dynamics'
 * '<S251>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/States Constraints/Tire Bounds'
 * '<S252>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/States Constraints/Anti reverse wheelspin/S-R Flip Flops'
 * '<S253>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/States Constraints/Anti reverse wheelspin/S-R Flip Flops/S-R Flip-Flop'
 * '<S254>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/States Constraints/Anti reverse wheelspin/S-R Flip Flops/S-R Flip-Flop1'
 * '<S255>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/States Constraints/Anti reverse wheelspin/S-R Flip Flops/S-R Flip-Flop2'
 * '<S256>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/States Constraints/Anti reverse wheelspin/S-R Flip Flops/S-R Flip-Flop3'
 * '<S257>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/States Constraints/Tire Bound Dynamics/Load Transfer Calculation'
 * '<S258>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/States Constraints/Tire Bound Dynamics/Slip Angle Calculation'
 * '<S259>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/States Constraints/Tire Bound Dynamics/Load Transfer Calculation/Fz FL'
 * '<S260>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/States Constraints/Tire Bound Dynamics/Load Transfer Calculation/Fz FR'
 * '<S261>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/States Constraints/Tire Bound Dynamics/Load Transfer Calculation/Fz RL'
 * '<S262>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/States Constraints/Tire Bound Dynamics/Load Transfer Calculation/Fz RR'
 * '<S263>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/States Constraints/Tire Bound Dynamics/Slip Angle Calculation/Slip Angle FL'
 * '<S264>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/States Constraints/Tire Bound Dynamics/Slip Angle Calculation/Slip Angle FR'
 * '<S265>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/States Constraints/Tire Bound Dynamics/Slip Angle Calculation/Slip Angle RL'
 * '<S266>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/States Constraints/Tire Bound Dynamics/Slip Angle Calculation/Slip Angle RR'
 * '<S267>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/States Constraints/Tire Bounds/Hydraulic brakes'
 * '<S268>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/States Constraints/Tire Bounds/LMUx Correction'
 * '<S269>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/Weights Generation/Efficiency limit'
 * '<S270>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/Weights Generation/MATLAB Function'
 * '<S271>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/MPC/Weights Generation/Efficiency limit/Power to engines'
 * '<S272>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/Reference Tracking/MATLAB Function'
 * '<S273>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/Reference Tracking/YRD_LUT_-1'
 * '<S274>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/Reference Tracking/YRD_LUT_-1.1'
 * '<S275>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/Reference Tracking/YRD_LUT_-1.5'
 * '<S276>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/Reference Tracking/YRD_LUT_-3'
 * '<S277>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/Reference Tracking/YRD_LUT_0'
 * '<S278>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/Reference Tracking/YRD_LUT_1'
 * '<S279>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/Reference Tracking/YRD_LUT_2'
 * '<S280>' : 'TVModel/Subsystem/Subsystem1/Torque Distribution/Reference Tracking/YRD_LUT_3'
 * '<S281>' : 'TVModel/Subsystem/Subsystem1/Torque Limits/Torque Limits Positive'
 * '<S282>' : 'TVModel/Subsystem/Subsystem1/Torque Limits/Torque Limits Regen'
 * '<S283>' : 'TVModel/Subsystem/Subsystem1/Torque Limits/Torque Request'
 * '<S284>' : 'TVModel/Subsystem/Subsystem1/Torque Limits/Torque Limits Positive/Torque_Curve'
 * '<S285>' : 'TVModel/Subsystem/Subsystem1/Torque Limits/Torque Limits Positive/Torque_Curve/Low-Pass Filter (Discrete or Continuous)'
 * '<S286>' : 'TVModel/Subsystem/Subsystem1/Torque Limits/Torque Limits Positive/Torque_Curve/Saturation Dynamic'
 * '<S287>' : 'TVModel/Subsystem/Subsystem1/Torque Limits/Torque Limits Positive/Torque_Curve/Low-Pass Filter (Discrete or Continuous)/Enable//disable time constant'
 * '<S288>' : 'TVModel/Subsystem/Subsystem1/Torque Limits/Torque Limits Positive/Torque_Curve/Low-Pass Filter (Discrete or Continuous)/Initialization'
 * '<S289>' : 'TVModel/Subsystem/Subsystem1/Torque Limits/Torque Limits Positive/Torque_Curve/Low-Pass Filter (Discrete or Continuous)/Integrator (Discrete or Continuous)'
 * '<S290>' : 'TVModel/Subsystem/Subsystem1/Torque Limits/Torque Limits Positive/Torque_Curve/Low-Pass Filter (Discrete or Continuous)/Enable//disable time constant/Compare To Zero'
 * '<S291>' : 'TVModel/Subsystem/Subsystem1/Torque Limits/Torque Limits Positive/Torque_Curve/Low-Pass Filter (Discrete or Continuous)/Initialization/Init_u'
 * '<S292>' : 'TVModel/Subsystem/Subsystem1/Torque Limits/Torque Limits Positive/Torque_Curve/Low-Pass Filter (Discrete or Continuous)/Integrator (Discrete or Continuous)/Discrete'
 * '<S293>' : 'TVModel/Subsystem/Subsystem1/Torque Limits/Torque Limits Regen/Torque_Curve'
 * '<S294>' : 'TVModel/Subsystem/Subsystem1/Torque Limits/Torque Limits Regen/Torque_Curve/Low-Pass Filter (Discrete or Continuous)'
 * '<S295>' : 'TVModel/Subsystem/Subsystem1/Torque Limits/Torque Limits Regen/Torque_Curve/Saturation Dynamic'
 * '<S296>' : 'TVModel/Subsystem/Subsystem1/Torque Limits/Torque Limits Regen/Torque_Curve/Low-Pass Filter (Discrete or Continuous)/Enable//disable time constant'
 * '<S297>' : 'TVModel/Subsystem/Subsystem1/Torque Limits/Torque Limits Regen/Torque_Curve/Low-Pass Filter (Discrete or Continuous)/Initialization'
 * '<S298>' : 'TVModel/Subsystem/Subsystem1/Torque Limits/Torque Limits Regen/Torque_Curve/Low-Pass Filter (Discrete or Continuous)/Integrator (Discrete or Continuous)'
 * '<S299>' : 'TVModel/Subsystem/Subsystem1/Torque Limits/Torque Limits Regen/Torque_Curve/Low-Pass Filter (Discrete or Continuous)/Enable//disable time constant/Compare To Zero'
 * '<S300>' : 'TVModel/Subsystem/Subsystem1/Torque Limits/Torque Limits Regen/Torque_Curve/Low-Pass Filter (Discrete or Continuous)/Initialization/Init_u'
 * '<S301>' : 'TVModel/Subsystem/Subsystem1/Torque Limits/Torque Limits Regen/Torque_Curve/Low-Pass Filter (Discrete or Continuous)/Integrator (Discrete or Continuous)/Discrete'
 * '<S302>' : 'TVModel/Subsystem/Subsystem1/Torque Limits/Torque Request/T_Req_Acceleration'
 * '<S303>' : 'TVModel/Subsystem/Subsystem1/Torque Limits/Torque Request/T_Req_Braking'
 * '<S304>' : 'TVModel/Subsystem/Subsystem1/Torque Limits/Torque Request/T_Req_Chart'
 */
