...
double Acados_Caller(double x0[],double extParam[],double limDown[],double limUp[],double reference[],double limAggrDown[],double limAggrUp[],dt_model_solver_capsule *capsule_long_,dt_model_solver_capsule * capsule){
  ...
  ocp_nlp_config *nlp_config = dt_model_acados_get_nlp_config(capsule_long_);
  ocp_nlp_dims *nlp_dims = dt_model_acados_get_nlp_dims(capsule_long_);
  ocp_nlp_in *nlp_in = dt_model_acados_get_nlp_in(capsule_long_);
  ocp_nlp_out *nlp_out = dt_model_acados_get_nlp_out(capsule_long_);
  ...
  for (int ii = 0; ii < N_it; ii++) {
    ...
    dt_model_acados_update_params(capsule_long_, ii,(void *) extParam, 1);
  }
