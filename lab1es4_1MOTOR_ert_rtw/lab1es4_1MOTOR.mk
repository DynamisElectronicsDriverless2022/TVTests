###########################################################################
## Makefile generated for component 'lab1es4_1MOTOR'. 
## 
## Makefile     : lab1es4_1MOTOR.mk
## Generated on : Fri Apr 29 15:21:26 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/lab1es4_1MOTOR.out
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/lab1es4_1MOTOR.out
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/lab1es4_1MOTOR_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021b/toolbox/target/SUPPOR~1/tic2000/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021b/toolbox/shared/SUPPOR~1/tic2000/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021b/toolbox/shared/SUPPOR~1/tic2000/inc -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021b/toolbox/target/SUPPOR~1/tic2000/inc -IC:/ti/CONTRO~1/DEVICE~1/f2806x/v151/F2806X~1/include -IC:/ti/CONTRO~1/DEVICE~1/f2806x/v151/F2806X~4/include -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021b/toolbox/target/shared/EXTERN~1/include -I$(MATLAB_ROOT)/toolbox/rtw/targets/common/can/blocks/tlc_c
...
DEFINES_SKIPFORSIL = -DDAEMON_MODE=1 -DXCP_CUSTOM_PLATFORM -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DMW_PIL_SCIFIFOLEN=4 -DMW_F2806X -DSTACK_SIZE=1024 -DRT -DF28069 -DBOOT_FROM_FLASH=0 -DMW_FAST_RTS_INCLUDED=0
DEFINES_STANDARD = -DMODEL=lab1es4_1MOTOR -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/lab1es4_1MOTOR_ert_rtw/MW_c28xx_csl.c $(START_DIR)/lab1es4_1MOTOR_ert_rtw/MW_c28xx_board.c $(START_DIR)/lab1es4_1MOTOR_ert_rtw/DSP28xx_SciUtil.c $(START_DIR)/lab1es4_1MOTOR_ert_rtw/MW_c28xx_adc.c $(START_DIR)/lab1es4_1MOTOR_ert_rtw/MW_c28xx_pwm.c $(START_DIR)/lab1es4_1MOTOR_ert_rtw/lab1es4_1MOTOR.c $(START_DIR)/lab1es4_1MOTOR_ert_rtw/lab1es4_1MOTOR_data.c C:/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/target/supportpackages/tic2000/src/c2806xBoard_Realtime_Support.c C:/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/shared/supportpackages/tic2000/src/MW_c28xGlobalInterrupts.c C:/ti/controlSUITE/device_support/f2806x/v151/F2806x_common/source/F2806x_CpuTimers.c C:/ti/controlSUITE/device_support/f2806x/v151/F2806x_common/source/F2806x_DefaultIsr.c C:/ti/controlSUITE/device_support/f2806x/v151/F2806x_headers/source/F2806x_GlobalVariableDefs.c C:/ti/controlSUITE/device_support/f2806x/v151/F2806x_common/source/F2806x_PieCtrl.c C:/ti/controlSUITE/device_support/f2806x/v151/F2806x_common/source/F2806x_PieVect.c C:/ti/controlSUITE/device_support/f2806x/v151/F2806x_common/source/F2806x_SysCtrl.c C:/ti/controlSUITE/device_support/f2806x/v151/F2806x_common/source/F2806x_usDelay.asm C:/ti/controlSUITE/device_support/f2806x/v151/F2806x_common/source/F2806x_CodeStartBranch.asm C:/ti/controlSUITE/device_support/f2806x/v151/F2806x_common/source/F2806x_Dma.c C:/ti/controlSUITE/device_support/f2806x/v151/F2806x_common/source/F2806x_Adc.c C:/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/target/supportpackages/tic2000/src/blapp_support.c C:/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/target/supportpackages/tic2000/src/profiler_Support.c C:/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/shared/supportpackages/tic2000/src/MW_c28xGPIO.c C:/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/target/supportpackages/tic2000/src/c2806xSchedulerTimer0.c

MAIN_SRC = $(START_DIR)/lab1es4_1MOTOR_ert_rtw/ert_main.c
...
CFLAGS_SKIPFORSIL = -v28 -ml --float_support=fpu32 -DF28069 -DBOOT_FROM_FLASH=0
...
CPPFLAGS_SKIPFORSIL = -v28 -ml --float_support=fpu32 -DF28069 -DBOOT_FROM_FLASH=0
...
CPP_LDFLAGS_SKIPFORSIL = --define F28069 --define BOOT_FROM_FLASH=0 --define BOOT_USING_BL=0
...
CPP_SHAREDLIB_LDFLAGS_SKIPFORSIL = --define F28069 --define BOOT_FROM_FLASH=0 --define BOOT_USING_BL=0
...
LDFLAGS_SKIPFORSIL = --define F28069 --define BOOT_FROM_FLASH=0 --define BOOT_USING_BL=0
...
SHAREDLIB_LDFLAGS_SKIPFORSIL = --define F28069 --define BOOT_FROM_FLASH=0 --define BOOT_USING_BL=0
...
%.obj : $(START_DIR)/lab1es4_1MOTOR_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/lab1es4_1MOTOR_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/lab1es4_1MOTOR_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/lab1es4_1MOTOR_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_csl.obj : $(START_DIR)/lab1es4_1MOTOR_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/lab1es4_1MOTOR_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


DSP28xx_SciUtil.obj : $(START_DIR)/lab1es4_1MOTOR_ert_rtw/DSP28xx_SciUtil.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_adc.obj : $(START_DIR)/lab1es4_1MOTOR_ert_rtw/MW_c28xx_adc.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_pwm.obj : $(START_DIR)/lab1es4_1MOTOR_ert_rtw/MW_c28xx_pwm.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/lab1es4_1MOTOR_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


lab1es4_1MOTOR.obj : $(START_DIR)/lab1es4_1MOTOR_ert_rtw/lab1es4_1MOTOR.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


lab1es4_1MOTOR_data.obj : $(START_DIR)/lab1es4_1MOTOR_ert_rtw/lab1es4_1MOTOR_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


c2806xBoard_Realtime_Support.obj : C:/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/target/supportpackages/tic2000/src/c2806xBoard_Realtime_Support.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
...
blapp_support.obj : C:/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/target/supportpackages/tic2000/src/blapp_support.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
...
c2806xSchedulerTimer0.obj : C:/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/target/supportpackages/tic2000/src/c2806xSchedulerTimer0.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
