...
set COMPILER=C:\ProgramData\MATLAB\SupportPackages\R2021b\3P.instrset\mingw_w64.instrset\bin\gcc
                ...
                set LINKFLAGS=-m64 -Wl,--no-undefined -shared -static -L"A:\Downloads\Apps\Matlab2021b\extern\lib\win64\mingw64" -llibmx -llibmex -llibmat -lm -llibmwlapack -llibmwblas -Wl,"A:\Downloads\Apps\Matlab2021b/extern/lib/win64/mingw64/mexFunction.def"
                set LINKDEBUGFLAGS=-g
                set NAME_OUTPUT=-o "%OUTDIR%%MEX_NAME%%MEX_EXT%"
set PATH=C:\ProgramData\MATLAB\SupportPackages\R2021b\3P.instrset\mingw_w64.instrset\bin;A:\Downloads\Apps\Matlab2021b\extern\include\win64;A:\Downloads\Apps\Matlab2021b\extern\include;A:\Downloads\Apps\Matlab2021b\simulink\include;A:\Downloads\Apps\Matlab2021b\lib\win64;%MATLAB_BIN%;%PATH%
...
set LIBPATH=A:\Downloads\Apps\Matlab2021b\extern\lib\win64;%LIBPATH%

gmake SHELL="cmd" -f TorqueVectoring_sfun.gmk
